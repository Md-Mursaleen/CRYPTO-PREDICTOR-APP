    ...
    return (
        <BottomTab.Navigator screenOptions={{
            ...
            <BottomTab.Screen name='Cryptos' component={CryptoHomeScreen} options={{
                ...
                tabBarIcon: ({ color, focused }) => !focused ? <FontAwesome name='bitcoin' size={26} color={color} /> : <Zocial name='bitcoin' size={30} color={color} />
            }} />
            <BottomTab.Screen name='Portfolio' component={PortfolioScreen} options={{
                tabBarLabelStyle: styles.tabBarLabelStyle,
                tabBarIcon: ({ color, focused }) => !focused ? <Feather name='pie-chart' size={24} color={color} /> : <Fontisto name='pie-chart-1' size={26} color={color} />
            }} />
            <BottomTab.Screen name='Watchlist' component={WatchlistScreen} options={{
                tabBarLabelStyle: styles.tabBarLabelStyle,
                tabBarIcon: ({ color, focused }) => !focused ? <FontAwesome5 name='star' size={22} color={color} /> : <FontAwesome name='star' size={26} color={color} />
            }} />
            <BottomTab.Screen name='Crypto News' component={CryptoNewsScreen} options={{
                tabBarLabelStyle: styles.tabBarLabelStyle,
                tabBarIcon: ({ color, focused }) => !focused ? <Ionicons name='reader-outline' size={27} color={color} /> : <Ionicons name='reader' size={29} color={color} />
            }} />
            ...
            <BottomTab.Screen name='Stocks' component={StockHomeScreen} options={{
                tabBarLabelStyle: styles.tabBarLabelStyle,
                tabBarIcon: ({ color, focused }) => !focused ? <AntDesign name='apple-o' size={27} color={color} /> : <AntDesign name='apple1' size={29} color={color} />
            }} />
        </BottomTab.Navigator>
    );
}
