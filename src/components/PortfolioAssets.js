        ...
        assets?.length === 0 ? (
            <>
                ...
                <View>
                    ...
                    <Text style={[styles.headerSubTitleTextStyle, { marginTop: normalize(18) }]}>Add the first asset by tapping on the</Text>
            ...
            <SwipeListView data={assets}
                    ...
                    <>
                        ...
                        <View style={styles.balanceContainer}>
                            <View>
                                ...
                                <Text style={[styles.changePriceTextStyle, { color: currentValue() >= 0 ? '#6AC77E' : '#D0585C' }]}>${currentValue()} (24h)</Text>
                            </View>
                            <View style={[styles.percentageChangeContainer, { backgroundColor: currentValue() >= 0 ? '#6AC77E' : '#D0585C' }]}>
                                <AntDesign name={currentValue() >= 0 ? 'caretup' : 'caretdown'} color='#FFFFFF' style={styles.iconStyle} />
                ...
                ListFooterComponent={
                    <Pressable onPress={() => navigation.navigate('AddAsset')} style={styles.buttonContainer} >
                        <Text style={styles.buttonTextStyle}>Add New Asset</Text>
                    </ Pressable>
                } />
        )
