        ...
        <>
            <View style={styles.container}>
                <View style={styles.headerContainer}>
                    ...
                    <Pressable onPress={openDrawer}>
                        <Image source={require('../../assets/images/profile-pic.png')} style={styles.profileImageStyle} />
                    </Pressable>
                </View>
            ...
            {drawerVisible && (
                <>
                    ...
                    <Animated.View style={[styles.drawerStyle, { transform: [{ translateX: drawerAnimation }] }]} pointerEvents='box-none'>
