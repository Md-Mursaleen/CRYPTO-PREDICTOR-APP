                                ...
                                <FlatList data={searchResults}
                                    ...
                                    renderItem={({ item }) => (
                                        <TouchableOpacity onPress={() => handleSelectStock(item.symbol)}>
                                            <Text style={styles.searchResultsTextStyle}>{item}</Text>
                                        </TouchableOpacity>
                                    )} />
                            </View>
                        </TouchableWithoutFeedback>
            ...
            <View style={styles.headerContainer}>
                <View style={styles.headerSubContainer}>
                    ...
                    <View style={styles.stockTextContainer}>
                        <Text style={styles.stockNameTextStyle}>{stockData?.companyName.toUpperCase()}</Text>
                        <Text style={styles.stockTickerTextStyle}>{stockData?.symbol}, {stockData?.currency}</Text>
                        <Text style={styles.stockExchangeTextStyle}>{stockData?.exchange}</Text>
                    </View>
                </View>
                <View>
                    <Text style={styles.stockPriceTextStyle}>${stockData?.price.toFixed(2)}</Text>
                    <View style={styles.stockPercentageChangeContainer}>
                        ...
                        <Text style={[styles.stockPercentageChangeTextStyle, { color: parseFloat(percentageChange) > 0 ? '#6AC77E' : '#D0585C' }]}>
            ...
            <View style={styles.detailsContainer}>
                ...
                <View style={styles.detailsSubContainer}>
                    <View style={styles.detailSubContainer}>
                        <Text style={styles.stockDetailTextStyle}>Industry: {truncate(stockData?.industry, 15)}</Text>
                    </View>
                    <View style={styles.detailSubContainer}>
                        <Text style={styles.stockDetailTextStyle}>Sector: {truncate(stockData?.sector, 10)}</Text>
                    </View>
                </View>
                <View style={styles.detailsBottomContainer}>
                    <View style={styles.bottomSubContainer}>
                        <Text style={styles.stockKeyTextStyle}>Market Cap</Text>
                        <Text style={styles.stockValueTextStyle}>${cryptoMarketCap(Number(stockData?.mktCap))}</Text>
                    </View>
                    <View style={styles.bottomSubContainer}>
                        <Text style={styles.stockKeyTextStyle}>Central Index Key</Text>
                        <Text style={styles.stockValueTextStyle}>{stockData?.cik}</Text>
                    </View>
                    <View style={styles.bottomSubContainer}>
                        <Text style={styles.stockKeyTextStyle}>Beta</Text>
                        <Text style={styles.stockValueTextStyle}>{stockData?.beta}</Text>
                    </View>
                </View>
                <View style={[styles.detailsBottomContainer, { marginTop: normalize(15) }]}>
                    <View style={styles.bottomSubContainer}>
                        <Text style={styles.stockKeyTextStyle}>Last Dividend</Text>
                        <Text style={styles.stockValueTextStyle}>${stockData?.lastDiv}</Text>
                    </View>
                    <View style={styles.bottomSubContainer}>
                        <Text style={styles.stockKeyTextStyle}>Volume Average</Text>
                        <Text style={styles.stockValueTextStyle}>{stockData?.volAvg}</Text>
                    </View>
                    <View style={styles.bottomSubContainer}>
                        <Text style={styles.stockKeyTextStyle}>Discounted CF</Text>
                        <Text style={styles.stockValueTextStyle}>${(stockData?.dcf || 0).toFixed(2)}</Text>
                    </View>
                </View>
            </View>
        </ScrollView>
...
const styles = StyleSheet.create({
    ...
    stockTickerTextStyle: {
        fontSize: 13,
        fontWeight: '500',
        fontFamily: 'PlusJakartaSans-Medium',
        color: '#5E80FC',
    },
    stockExchangeTextStyle: {
        fontSize: 12,
        fontWeight: '500',
